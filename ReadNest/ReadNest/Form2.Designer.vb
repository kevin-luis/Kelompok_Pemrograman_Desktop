...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Font = New Font("UD Digi Kyokasho NP-B", 30.25F, FontStyle.Bold)
        ...
        Label2.Font = New Font("UD Digi Kyokasho NP-B", 25.25F, FontStyle.Bold)
        Label2.ForeColor = SystemColors.ControlText
        Label2.ImageAlign = ContentAlignment.TopRight
        Label2.Location = New Point(12, 30)
        Label2.Name = "Label2"
        Label2.Size = New Size(215, 39)
        Label2.TabIndex = 9
        ...
        btnLoginaAccount.Font = New Font("UD Digi Kyokasho NK-B", 11.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(128))
